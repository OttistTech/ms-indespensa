...
public record UpdateUserDTO(
        ...
        @NotNull(message = "Field addressNumber is required") @Min(value = 1, message = "Field addressNumber should be at least 1 (>= 1)") @Max(value = 9999, message = "Field addressNumber should be less than 5 (< 4)") Integer addressNumber,
